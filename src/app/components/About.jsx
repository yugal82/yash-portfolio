            ...
            <div className='lg:flex items-start justify-center gap-8 py-8 px-4'>
                ...
                <div className='mt-4 md:mt-0'>
                    ...
                    <p className='text-base text-justify md:text-lg text-[#adb7b3]'>
                        I personally am driven by the purpose of having a profound impact on small and medium scale businesses and assisting them in their most important financial transactions and achieving what they truly deserve. I am very fortunate to have been raised in a very entrepreneurial household that shaped my upbringing filled with learnings about business, finance, and investments. And this has played an imperative role as I navigated my academic and  professional callings. Additionally, it also instilled in me the appreciation of work ethic, persistence and consistency, and integrity. 
                        <br></br>
                        <br></br>
                        Over the years, I have built a robust foundation in investment banking, investment analysis, and corporate development through various professional and academic undertakings. It also helped me in build hands on experience of the core finance skills like financial modeling, financial statement analysis, 3 statement modeling, valuation analysis, portfolio management, investment analysis, etc. that are all valuable in today’s rapidly changing and dynamic finance industry.
                        <br></br>
                        <br></br>
                        Growing up, I also indulged myself in sports which in high school and in college, became a competitive pursuit. I was the captain of the school and college soccer teams and enjoyed thriving in a highly competitive environment. Similarly, I strive greatly in a competitive and a fast-paced professional setting where challenges help me in outgrowing myself. Whether it’s cranking numbers on a spreadsheet or putting on the qualitative lens, I enjoy both if it results in positive and meaningful contributions within the business landscape.
