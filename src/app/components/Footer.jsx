...
const Footer = () => {
  return (
    <div className='py-4 bg-[#282828] rounded-t-xl mt-12 md:mt-24'>
      <h2 className='text-2xl text-center py-2 font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#09A6F3] via-[#0B74EA] to-[#0D41E1]'>~Yash/Khanter~</h2>
      ...
      <div className='w-full py-2 text-center text-sm font-semibold'> All rights reserved | &#169; 2026</div>
    </div>
  )
}
